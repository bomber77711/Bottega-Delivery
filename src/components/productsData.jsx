...
//   - categories is an array of OBJECTS { name, emoji, image }; product.category must
...
export const categories = [
  { name: 'Olive Oil', emoji: '\u{1FAD2}', image: 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=400&q=80' },
  { name: 'Wine', emoji: '\u{1F377}', image: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=400&q=80' },
  { name: 'Cheese', emoji: '\u{1F9C0}', image: 'https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=400&q=80' },
  { name: 'Cured Meats', emoji: '\u{1F969}', image: 'https://images.unsplash.com/photo-1542901031-ec5eeb518e8e?w=400&q=80' },
  { name: 'Pasta', emoji: '\u{1F35D}', image: 'https://images.unsplash.com/photo-1551462147-ff29053bfc14?w=400&q=80' },
  { name: 'Truffle', emoji: '\u{1F344}', image: 'https://images.unsplash.com/photo-1505575972945-280edd1d2b1f?w=400&q=80' },
  { name: 'Coffee', emoji: '☕', image: 'https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=400&q=80' },
  { name: 'Preserves', emoji: '\u{1F36F}', image: 'https://images.unsplash.com/photo-1472476443507-c7a5948772fc?w=400&q=80' },
  { name: 'Honey', emoji: '\u{1F36F}', image: 'https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=400&q=80' },
  { name: 'Sweets', emoji: '\u{1F36B}', image: 'https://images.unsplash.com/photo-1481391319762-47dff72954d9?w=400&q=80' },
];
